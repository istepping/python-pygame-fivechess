...
os.environ['TCL_LIBRARY'] = r"F:\Anaconda3\DLLs\tcl8.6"
os.environ['TK_LIBRARY'] = r"F:\Anaconda3\DLLs\tk8.6"
# Dependencies are automatically detected, but it might need fine tuning.


# 中文需要显式用gbk方式编码

product_name = u'对战五子棋'.encode('gbk')

unproduct_name = u'卸载五子棋'.encode('gbk')

product_desc = u"对战五子棋 ver1.0".encode("gbk")
...
target_name = 'startGame.exe'

build_exe_options = {

    "include_files": ["../algorithm",
                      "../common",
                      "../main",
                      "../utils",
                      "../../res/icon",
                      "../../res/base"],  # 包含外围的ini、jpg文件，以及data目录下所有文件，以上所有的文件路径都是相对于cxsetup.py的路径。

    "packages": ["os", "pygame"],  # 包含用到的包
